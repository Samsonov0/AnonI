...
async def main():
    await anoni.register_router(
        hello_world_router
    )  # Use register_router method to register your handlers in router
    await anoni.register_router(users_router)  # Registration of "users" router
